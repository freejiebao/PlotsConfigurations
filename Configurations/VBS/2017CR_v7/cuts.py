...
tauVeto3='Sum$(Tau_pt > 18 && Tau_rawIso >=1 && sqrt( pow(Tau_eta - Alt$(Lepton_eta[0],-9999.), 2) + pow(abs(abs(Tau_phi - Alt$(Lepton_phi[0],-9999.))-pi)-pi, 2) ) >= 0.3 && sqrt( pow(Tau_eta - Alt$(Lepton_eta[1],-9999.), 2) + pow(abs(abs(Tau_phi - Alt$(Lepton_phi[1],-9999.))-pi)-pi, 2) ) >= 0.3) == 0'
...
cuts['ww_tauVeto3']='Alt$(Lepton_pt[0],0.)>25 && Alt$(Lepton_pt[1],0.)>20 && Alt$(Lepton_pt[2],0.)<10 &&  Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],-9999) >0 && abs(Alt$(CleanJet_eta[0],-9999.)) < 5.0 && abs(Alt$(CleanJet_eta[1],-9999.)) < 5.0 && Alt$(CleanJet_pt[0],-9999.)>30 && Alt$(CleanJet_pt[1],-9999.)>30 && detajj > 2.5 && MET_pt> 30 && mll>10 && dmZll_veto >10&&'+ lep_eta+ '&&'+ tauVeto3
